...
import me.shadow.eclipselaunch.feature.version.VersionsManager.getEclipseVersionPath
import me.shadow.eclipselaunch.setting.AllSettings
import me.shadow.eclipselaunch.utils.stringutils.StringUtils.getStringNotNull
...
class VersionConfig(private var versionPath: File) : Parcelable {
    ...
    fun saveWithThrowable() {
        ...
        val eclipseVersionPath = getEclipseVersionPath(versionPath)
        val configFile = File(eclipseVersionPath, "VersionConfig.json")
