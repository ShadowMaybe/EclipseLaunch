package me.shadow.eclipselaunch.feature.update
...
import me.shadow.eclipselaunch.feature.update.LauncherVersion.FileSize
...
import me.shadow.eclipselaunch.ui.dialog.UpdateDialog
...
class UpdateUtils {
    companion object {
        ...
        fun getDownloadUrl(launcherVersion: LauncherVersion): String {
            ...
            return "https://github.com/EclipseLaunch/EclipseLaunch/releases/download/" +
                    "${launcherVersion.versionCode}/EclipseLaunch-${launcherVersion.versionName}" +
